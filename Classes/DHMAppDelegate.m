...
#import "DHMAppDelegate.h"
#import "DHMController.h"
#import "BannerViewController.h"

@implementation DHMAppDelegate

- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{    
    // Restore app settings
    [[DHMController sharedInstance] restoreAppSettings];
    
    // Check if onboarding is necessary
    BOOL showOnboarding = [DHMController sharedInstance].onboardingShouldDisplay;
    
    if(showOnboarding)
    {
        // Display the onboarding VC and allow the onboarding segue to setup ads
    ...
    {
        // No onboarding so immediately setup ads through the BannerViewController
        UIViewController* tabBarController = [self.window.rootViewController.storyboard
