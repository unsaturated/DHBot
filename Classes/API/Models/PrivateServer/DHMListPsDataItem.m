...
@implementation DHMListPsDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMListPsDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMListPsDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMListPsDataItem objectMappingForREST];
