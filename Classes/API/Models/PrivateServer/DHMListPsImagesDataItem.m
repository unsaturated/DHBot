...
#import "DHMListPsImagesDataItem.h"
#import "DHMErrorData.h"

@implementation DHMListPsImagesDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMListPsImagesDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMListPsImagesDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMListPsImagesDataItem objectMappingForREST];
