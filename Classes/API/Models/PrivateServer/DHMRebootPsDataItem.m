...
@implementation DHMRebootPsDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMRebootPsDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMRebootPsDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMRebootPsDataItem objectMappingForREST];
