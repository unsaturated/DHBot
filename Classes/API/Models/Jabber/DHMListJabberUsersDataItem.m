...
@implementation DHMListJabberUsersDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMListJabberUsersDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMListJabberUsersDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMListJabberUsersDataItem objectMappingForREST];
