...
@implementation DHMApiListKeysDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMApiListKeysDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMApiListKeysDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMApiListKeysDataItem objectMappingForREST];
