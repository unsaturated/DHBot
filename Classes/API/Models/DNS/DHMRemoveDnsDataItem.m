...
#import "DHMRemoveDnsDataItem.h"
#import "DHMErrorData.h"

@implementation DHMRemoveDnsDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMRemoveDnsDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMRemoveDnsDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMRemoveDnsDataItem objectMappingForREST];
