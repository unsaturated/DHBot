...
#import "DHMAddDnsDataItem.h"
#import "DHMErrorData.h"

@implementation DHMAddDnsDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMAddDnsDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMAddDnsDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMAddDnsDataItem objectMappingForREST];
