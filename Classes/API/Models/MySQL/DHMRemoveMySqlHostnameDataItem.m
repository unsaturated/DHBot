...
#import "DHMRemoveMySqlHostnameDataItem.h"
#import "DHMErrorData.h"

@implementation DHMRemoveMySqlHostnameDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMRemoveMySqlHostnameDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMRemoveMySqlHostnameDataItem class]];
    
    // From service        : Property on class
    // @IncomingIdentifier : @LocalIdentifier
    [dataMapping addAttributeMappingsFromDictionary:@{
                                                      @"hostname_removed": @"hostnameRemoved"
                                                      }];
...
{
    RKObjectMapping *mapping = [DHMRemoveMySqlHostnameDataItem objectMappingForREST];
