...
@implementation DHMListMySqlHostnameDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMListMySqlHostnameDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMListMySqlHostnameDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMListMySqlHostnameDataItem objectMappingForREST];
