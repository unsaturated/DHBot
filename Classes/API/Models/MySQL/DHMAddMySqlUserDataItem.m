...
#import "DHMAddMySqlUserDataItem.h"
#import "DHMErrorData.h"

@implementation DHMAddMySqlUserDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMAddMySqlUserDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMAddMySqlUserDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMAddMySqlUserDataItem objectMappingForREST];
