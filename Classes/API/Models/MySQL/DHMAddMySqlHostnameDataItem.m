...
#import "DHMAddMySqlHostnameDataItem.h"
#import "DHMErrorData.h"

@implementation DHMAddMySqlHostnameDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMAddMySqlHostnameDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMAddMySqlHostnameDataItem class]];
    
    // From service        : Property on class
    // @IncomingIdentifier : @LocalIdentifier
    [dataMapping addAttributeMappingsFromDictionary:@{
                                                      @"hostname_added": @"hostnameAdded"
                                                      }];
...
{
    RKObjectMapping *mapping = [DHMAddMySqlHostnameDataItem objectMappingForREST];
