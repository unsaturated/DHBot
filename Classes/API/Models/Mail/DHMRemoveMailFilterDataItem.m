...
#import "DHMRemoveMailFilterDataItem.h"
#import "DHMErrorData.h"

@implementation DHMRemoveMailFilterDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMRemoveMailFilterDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMRemoveMailFilterDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMRemoveMailFilterDataItem objectMappingForREST];
