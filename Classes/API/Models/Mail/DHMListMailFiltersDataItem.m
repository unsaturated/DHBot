...
@implementation DHMListMailFiltersDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMListMailFiltersDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMListMailFiltersDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMListMailFiltersDataItem objectMappingForREST];
