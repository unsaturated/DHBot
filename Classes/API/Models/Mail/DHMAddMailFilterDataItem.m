...
#import "DHMAddMailFilterDataItem.h"
#import "DHMErrorData.h"

@implementation DHMAddMailFilterDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMAddMailFilterDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMAddMailFilterDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMAddMailFilterDataItem objectMappingForREST];
