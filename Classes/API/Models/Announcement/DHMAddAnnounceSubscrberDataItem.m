...
#import "DHMAddAnnounceSubscrberDataItem.h"
#import "DHMErrorData.h"

@implementation DHMAddAnnounceSubscrberDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMAddAnnounceSubscrberDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMAddAnnounceSubscrberDataItem class]];
    
    // From service        : Property on class
    // @IncomingIdentifier : @LocalIdentifier
    [dataMapping addAttributeMappingsFromDictionary:@{
                                                      @"sent_opt_in_email": @"sentOptInEmail"
                                                      }];
...
{
    RKObjectMapping *mapping = [DHMAddAnnounceSubscrberDataItem objectMappingForREST];
