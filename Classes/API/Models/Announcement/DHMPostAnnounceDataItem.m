...
#import "DHMPostAnnounceDataItem.h"
#import "DHMErrorData.h"

@implementation DHMPostAnnounceDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMPostAnnounceDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMPostAnnounceDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMPostAnnounceDataItem objectMappingForREST];
