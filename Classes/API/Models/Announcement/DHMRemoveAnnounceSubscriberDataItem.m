...
#import "DHMRemoveAnnounceSubscriberDataItem.h"
#import "DHMErrorData.h"

@implementation DHMRemoveAnnounceSubscriberDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMRemoveAnnounceSubscriberDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMRemoveAnnounceSubscriberDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMRemoveAnnounceSubscriberDataItem objectMappingForREST];
