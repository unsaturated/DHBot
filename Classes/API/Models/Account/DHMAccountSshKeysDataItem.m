...
@implementation DHMAccountSshKeysDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMAccountSshKeysDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMAccountSshKeysDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMAccountSshKeysDataItem objectMappingForREST];
