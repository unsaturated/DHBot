...
@implementation DHMAccountStatusDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMAccountStatusDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMAccountStatusDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMAccountStatusDataItem objectMappingForREST];
