...
@implementation DHMAccountUsageDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMAccountUsageDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMAccountUsageDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMAccountUsageDataItem objectMappingForREST];
