...
@implementation DHMAccountUserUsageDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMAccountUserUsageDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMAccountUserUsageDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMAccountUserUsageDataItem objectMappingForREST];
