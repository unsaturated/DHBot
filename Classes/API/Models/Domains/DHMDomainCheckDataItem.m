...
@implementation DHMDomainCheckDataItem
...
+(RKObjectMapping*) objectMappingForREST
{
    ...
    RKObjectMapping *mapping = [RKObjectMapping mappingForClass:[DHMDomainCheckDataItem class]];
    
    // The data property within the valid item
    RKObjectMapping *dataMapping = [RKObjectMapping mappingForClass:[DHMDomainCheckDataItem class]];
...
{
    RKObjectMapping *mapping = [DHMDomainCheckDataItem objectMappingForREST];
