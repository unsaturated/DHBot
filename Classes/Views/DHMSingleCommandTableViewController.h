...
/**
 Base view-controller class for a single command that return a list of objects. 
 Aggregate command VCs should not use this class.
 */
@interface DHMSingleCommandTableViewController : UITableViewController
{
    @protected
